...
public class PlantUMLInterpreterTest {

  private PlantUMLInterpreter shell;
  ...
  public void setUp() throws Exception {
    ...
    p.setProperty("plantuml.render.timeout.millisecs", "2000");
    shell = new PlantUMLInterpreter(p);
